 ...
 */
export declare function mapAsyncIterable<T, U, R = undefined, N = void>(iterable: AsyncGenerator<T, R, N>, fn: (value: T) => PromiseOrValue<U>): AsyncGenerator<U, R, N>;
export declare function mapAsyncIterable<T, U, R, N>(iterable: CustomAsyncIterable<T, R, N>, fn: (value: T) => PromiseOrValue<U>): CustomAsyncIterableIterator<U, R, N>;
export {};
