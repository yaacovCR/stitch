...
function _inlineFragments(node, fragments) {
    ...
    return visitWithMemo(node, {
        [Kind.SELECTION_SET]: (selectionSetNode) => processSelectionSet(selectionSetNode, fragmentMap),
    }, {
...
function processSelectionSet(selectionSet, fragmentMap, visitedFragments = new Set()) {
    return updateNode(selectionSet, 'selections', processSelections(selectionSet.selections, fragmentMap, visitedFragments));
}
...
function toInlineFragment(spreadNode, fragmentMap, visitedFragments) {
    ...
    newNode = updateNode(newNode, 'selectionSet', processSelectionSet(fragment.selectionSet, fragmentMap, visitedFragments));
    return newNode;
}
